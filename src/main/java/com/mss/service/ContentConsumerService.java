...
public class ContentConsumerService {
    ...
    public void fetchAndSaveContents() {
        // Define the API URL
        String API_URL = "https://demo.webmanza.com/a55dbz923ace647v/api/v1.0/services/content";
        restTemplate.getMessageConverters().add(new StringHttpMessageConverter());
        ResponseEntity<ContentApiResponse> response = null;
        try {
            response = restTemplate.getForEntity(API_URL, ContentApiResponse.class);
            System.out.println("Response Status Code: " + response.getStatusCode());
            System.out.println("Response Body: " + response.getBody());

            assert response != null;
            System.err.println(response.getStatusCode() + "\n...................................................");
            ContentApiResponse apiResponse = response.getBody();
